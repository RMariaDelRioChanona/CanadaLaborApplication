...
# Define regions
all_regions = ['Alberta.a', 'British Columbia.a', 'Manitoba.a', 'New Brunswick.a',
               'Newfoundland and Labrador.a', 'Nova Scotia.a', 'Ontario.a',
               'Ontario.b', 'Prince Edward Island.a', 'Quebec.a', 'Quebec.b', 'Saskatchewan.a', 'National']
...
lab_abm = lbm.LabourABM(N, T, seed, delta_u, delta_v, gamma_u, gamma_v, lam, beta_e, beta_u,
                        A, d_dagger, e, u, v, wages)
...
def plot_occupation_metrics(times, lab_abm, occ, dict_nodeid_title, region, T_steady):
    ...
    axes[1].plot(times, lab_abm.unemployment[occ, T_steady:] / 
    ...
    axes[2].plot(times, lab_abm.vacancies[occ, T_steady:] / 
                 (lab_abm.vacancies[occ, T_steady:] + lab_abm.employment[occ, T_steady:]))
